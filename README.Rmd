...
>
> This README.Rmd explains how the template works. When you use this for your own package, **replace this entire file** with documentation specific to your package. (Don't just edit it—start fresh!)

## What is blankpkg?

`blankpkg` is a comprehensive R package template that gives you a complete development infrastructure out of the box. No need to set up the boring stuff—it's all here:
...
- `setup_new_package.R` - Reference for package creation
